...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, pinCode) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js"}],"updateMember.js":[function(require,module,exports) {
"use strict";
...
var updateData = exports.updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(firstName, lastName, email, phoneNumber, address,
  // sex,
  goal, program, height, weight, bfat, bmi, waist, arm, thigh,
  // experiance,
  ...
  return function updateData(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16, _x17) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateMemberForm = document.querySelector('.update-member-form');
var dayWeek = document.querySelectorAll(".dayWeek");
var date = document.querySelectorAll(".date");
var td = document.querySelectorAll("td");
var book = document.querySelector(".modal-booking");
var eks = document.querySelector(".close");
...
if (updateMemberForm) {
  updateMemberForm.addEventListener('submit', function (e) {
    ...
    var bodyFat = document.getElementById('bfat').value;
    ...
    (0, _updateMember.updateData)(firstName, lastName, email, photo, phoneNumber, address,
    // sex,
    goal, program, height, weight, bodyFat, bmi, waist, arm, thigh,
    // experiance,
    squat, bench, deadlift);
  });
}
